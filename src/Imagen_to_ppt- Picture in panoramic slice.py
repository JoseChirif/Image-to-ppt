...
def create_presentation():
    ...
    def build_presentation(report_progress):
        """
        Build and save the presentation while reporting the number
        of processed images.
        """
        ...
        for image_number, image in enumerate(images, start=1):
            ...
            if option_nr == 1:
                ...
                # Add an orange background to the text box
                fill = txBox.fill
                fill.solid()
            ...
            # The image has now been completely processed.
            report_progress(
                image_number,
                image,
            )

        # Keep the progress bar full while saving the file.
        report_progress(
            len(images),
    ...
    # Execute the generation and display the progress window.
